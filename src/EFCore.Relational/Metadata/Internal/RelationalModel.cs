        ...
        public static IModel AddRelationalModel([NotNull] IConventionModel model)
        {
            ...
            foreach (var entityType in model.GetEntityTypes())
            {
                ...
                foreach (var property in entityType.GetDeclaredProperties())
                {
                    ...
                    var columnMappings = property[RelationalAnnotationNames.ColumnMappings] as SortedSet<ColumnMapping>;
                    if (columnMappings == null)
                    {
                        columnMappings = new SortedSet<ColumnMapping>(ColumnMappingComparer.Instance);
                        property.SetAnnotation(RelationalAnnotationNames.ColumnMappings, columnMappings);
                    }
